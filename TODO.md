...
`mandrill_sentry_wraparound.md` — Sentry (the error-tracking company) hit wraparound in July 2015; Mandrill — Mailchimp's transactional-email product, hit it in February 2019; consult Mailchimp's postmortem writeup (which links to Sentry's) to recast the stories in housekeeping vocabulary.
